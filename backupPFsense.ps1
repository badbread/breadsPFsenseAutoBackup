...
$backupdir = "\" #where your backup files will go (leave a trailing \)
$appdir = "\" #where the exe lives (leave a trailing \)
...
$HowOld = (Get-Date).AddDays($retention); #how many days before old backups get deleted
...
function create_backup {
    ...
    write-log -text "Executing the backup exe..." -type INFO
